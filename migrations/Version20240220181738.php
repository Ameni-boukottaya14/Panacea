 ...
 */
final class Version20240220181738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ordonnance ADD pharmacie_id INT NOT NULL, ADD medicaments VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ordonnance DROP pharmacie_id, DROP medicaments');
    }
}
